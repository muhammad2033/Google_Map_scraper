...
# Key points!
This program is not scraping 100% mails , social media's link , services and about section. 
Try to use the crawler for this program and get the all requirements.